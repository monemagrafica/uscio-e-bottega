...
function Cart({ dati, openCart, setOpenCart, removeFromCart, updateItem }) {
        ...
        <AnimatePresence>
            {(openCart && dati.length) &&
                ...
                >
                    ...
                    <ListItemCart update={update} setUpdate={setUpdate} dati={dati} removeFromCart={removeFromCart} />
